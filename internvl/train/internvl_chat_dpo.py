...
class DPOConfig(DPOConfigTRL):
    ...
    # Disable on-policy generation during training; we provide chosen/rejected pairs
    generate_during_training: bool = False
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        #assert 1==2, "here!"  
        ref_model = InternVLChatModel.from_pretrained("/share/project/honghaochen/output/internvl/sft_mpo_5e_6_add_special_token_prm", torch_dtype=torch.bfloat16, config=config)
